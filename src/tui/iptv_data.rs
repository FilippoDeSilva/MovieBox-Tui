pub const CATEGORIES: &[&str] = &["Animation", "Auto", "Business", "Classic", "Comedy", "Cooking", "Culture", "Documentary", "Education", "Entertainment", "Family", "General", "Interactive", "Kids", "Legislative", "Lifestyle", "Movies", "Music", "News", "Outdoor", "Public", "Relax", "Religious", "Science", "Series", "Shop", "Sports", "Travel", "Weather", "XXX", "Undefined"];
pub const LANGUAGES: &[(&str, &str)] = &[    ("Ghotuo", "aaa"),
    ("Alumu-Tesu", "aab"),
    ("Ari", "aac"),
    ("Amal", "aad"),
    ...
    ("finlandssvenskt teckenspråk", "fss"),
    ...
    ("Orok", "oaa"),
    ("Oroch", "oac"),
    ("Ancient Aramaic (up to 700 BCE)", "oar"),
    ("Old Avar", "oav"),
    ("Obispeño", "obi"),
    ("Southern Bontok", "obk"),
    ("Oblo", "obl"),
    ...
    ("Fyam", "pym"),
    ("Poyanáwa", "pyn"),
    ("Lengua de Señas del Paraguay", "pys"),
    ("Puyuma", "pyu"),
    ("Pyu (Myanmar)", "pyx"),
    ("Pyen", "pyy"),
    ("Para Naga", "pzn"),
    ...
    ("Llengua de signes valenciana", "vsv"),
    ("Vitou", "vto"),
    ("Vumbu", "vum"),
    ("Vunjo", "vun"),
    ("Vute", "vut"),
...
pub const COUNTRIES: &[(&str, &str)] = &[    ("Afghanistan", "af"),
    ("Aland", "ax"),
    ("Albania", "al"),
    ("Algeria", "dz"),
    ("American Samoa", "as"),
